...
console.log("Connecting sockets to http://localhost:5001 ...");
...
clientSocket.on("connect_error", (err) => console.error("Client Error:", err));
advocateSocket.on("connect_error", (err) => console.error("Advocate Error:", err));
